...
bar_fig.update_layout(title="Bar Chart Example", xaxis_title="Category", yaxis_title="Sales")
...
def test_bar_chart_tooltip(dash_duo):
    ...
    WebDriverWait(dash_duo.driver, 10).until(EC.presence_of_element_located((By.ID, "bar-chart")))
    ...
    expected_content_part = f"Sales by Category,x: {categories[idx - 1]},y: {values[idx - 1]}"
